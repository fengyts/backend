$(function () {
    layui.extend({
        tableEdit: '/plugins/layui-treetable/tableEdit'  //表格树依赖tableEdit模块
        , tableTree: '/plugins/layui-treetable/tableTree'
        ...
        var treeTable = tableTree.render({
            ...
            parseData: function (res) {
                ...
                return {
                    "code": '',
                    // "msg": res.msg,
                    "count": res.jsonObject.data.count,
                    "data": res.data
                };
            },
        });
